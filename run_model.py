...
def main():
    parser = argparse.ArgumentParser(description="Run the model to predict similarity score.")
    ...
    with torch.no_grad():
        similarity_score = prediction_head(de_emb, en_emb)  # Get the similarity score as a Python float
